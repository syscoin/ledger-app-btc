...
# Syscoin
DEFINES   += COIN_P2PKH_VERSION=63 COIN_P2SH_VERSION=5 COIN_FAMILY=1 COIN_COINID=\"Syscoin\" COIN_COINID_HEADER=\"SYSCOIN\" COIN_COLOR_HDR=0xCCCCCC COIN_COLOR_DB=0xE6E6E6 COIN_COINID_NAME=\"Syscoin\" COIN_COINID_SHORT=\"SYS\" COIN_NATIVE_SEGWIT_PREFIX=\"sys\" COIN_KIND=COIN_KIND_SYSCOIN COIN_FLAGS=FLAG_SEGWIT_CHANGE_SUPPORT
APPNAME ="Syscoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported COIN - use bitcoin_testnet, bitcoin, bitcoin_cash, bitcoin_gold, litecoin, dogecoin, dash, zcash, horizen, komodo, stratis, peercoin, pivx, viacoin, vertcoin, stealth, digibyte, qtum, bitcoin_private, zcoin, gamecredits, zclassic, xsn, nix, lbry, resistance, syscoin)
endif
endif
