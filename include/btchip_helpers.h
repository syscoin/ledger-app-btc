...
unsigned long int btchip_read_u64(unsigned char *buffer, unsigned char be,
                                  unsigned char skipSign);
...
void btchip_write_u64_be(unsigned char *buffer, unsigned long int value);
void btchip_write_u64_le(unsigned char *buffer, unsigned long int value);
